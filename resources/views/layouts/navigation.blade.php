        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::user()->is_admin ? route('admin.users.index') : route('dashboard') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(!Auth::user()->is_admin)
                        ...
                        <x-nav-link :href="route('geofences.index')" :active="request()->routeIs('geofences.index')">
                            {{ __('Zones') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(!Auth::user()->is_admin)
                ...
                <x-responsive-nav-link :href="route('geofences.index')" :active="request()->routeIs('geofences.index')">
                    {{ __('Zones') }}
                </x-responsive-nav-link>
            @endif
